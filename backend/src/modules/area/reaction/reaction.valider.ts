...
import {ParameterType, ServiceReactionConstructor, ServiceReactionDefinition} from "../../../common/service.types";

@Injectable()
export class ReactionValider {

    validate_reaction_params(reaction: ServiceReactionDefinition, input_params: Record<string, any>): boolean {
