          ...
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                CardButton(
                  isRow: true,
                  label: CreateHomePage.selectedAction != null ? 'If ' : 'If This ',
                  color: Colors.black,
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => CreatePage(services: services)),
                    );
                  },
                  children: SizedBox(
                ...
                CardButton(
                  isRow: true,
                  label: CreateHomePage.selectedReaction != null ? 'Then ' : 'Then That ',
                  color: Colors.black,
                  textColor: Colors.white,
                  height: MediaQuery.of(context).size.height * 0.1,
                  onTap: () {
                    if (CreateHomePage.action == null || CreateHomePage.selectedAction == null) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                ...
                if (CreateHomePage.action != null && CreateHomePage.reaction != null)
                  CardButton(
                    isRow: true,
                    label: 'Create AREA',
