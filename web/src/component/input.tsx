		...
		return (
			<div className="relative w-[480px]">
				<input
					...
					value={value}
					onChange={(e) => !isFixed && onChange && onChange(e.target.value)}
					disabled={isFixed}
				/>
				{showToggle && (
					<button
					...
					>
						{visible ? (
							...
							<svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
								<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a10.05 10.05 0 012.223-3.555M6.1 6.1A9.954 9.954 0 0112 5c4.478 0 8.268 2.943 9.542 7a9.965 9.965 0 01-2.045 3.468M3 3l18 18" />
							</svg>
						)}
					</button>
				)}
