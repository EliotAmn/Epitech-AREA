...
export default function Summary({ actionService, action, reactionService, reaction }: SummaryProps) {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white rounded shadow text-center">
      ...
      <div className="text-left space-y-3 mb-6">
        ...
        <div><strong>Service (reaction) :</strong> {reactionService ?? "—"}</div>
        <div><strong>Reaction :</strong> {reaction ?? "—"}</div>
      </div>
